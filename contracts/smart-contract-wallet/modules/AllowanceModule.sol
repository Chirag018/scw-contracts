...
contract AllowanceModule is SignatureDecoder {
    ...
    function setAllowance(
        ...
        // However, keep in mind that this may result in data loss if the value of the address is greater than 2^48-1
        require(
            delegates[msg.sender][uint48(uint256(uint160(delegate)))]
                .delegate == delegate,
    ...
    function checkSignature(
        ...
        require(
            expectedDelegate == signer &&
                delegates[address(safe)][uint48(uint256(uint160(signer)))]
                    .delegate ==
                signer,
    ...
    function addDelegate(address delegate) public {
        // However, keep in mind that this may result in data loss if the value of the address is greater than 2^48-1.
        uint48 index = uint48(uint256(uint160(delegate)));
    ...
    function removeDelegate(address delegate, bool removeAllowances) public {
        // However, keep in mind that this may result in data loss if the value of the address is greater than 2^48-1.
        Delegate memory current = delegates[msg.sender][
            uint48(uint256(uint160(delegate)))
        ];
        ...
        delete delegates[msg.sender][uint48(uint256(uint160(delegate)))];
    ...
    function getDelegates(
        ...
        next = uint48(uint256(uint160(current.delegate)));
